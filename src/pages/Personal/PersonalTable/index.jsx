...
export default class PersonalTable extends Component {
  ...
  componentDidMount(){
      ...
      this.token2 = PubSub.subscribe('searchName',(_,stateObj)=>{
          this.setState(stateObj)
        })
  ...
  render() {
    ...
    return (
        <div>
          ...
          {/* <Table columns={columns} dataSource={[this.state.data[4]]} /> */}
          <Table columns={columns} dataSource={
            this.state.searchName===''?this.state.data:this.state.data.map((item,index)=>{
